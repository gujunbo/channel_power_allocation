...
The centralized optimization scheme achieves the highest quasiSINR, because the optimization formulation~\ref{QLP} obtains the global optima.
 \begin{figure}[h!]
    \centering
      \includegraphics[width=0.9\linewidth]{ECC_16_4_5e1-8_5000_1_20_10_TxPower.pdf}
...
It is also noticed that, the maximum permitted transmission power decided by linear optimization helps the channel allocation schemes achieve better SINR.
     \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{ECC_16_4_5e1-8_5000_1_20_10_SINREndTerminal.pdf}
  ...
  \begin{figure}[h!]
     \centering
     \includegraphics[width=0.8\linewidth]{ECC_16_4_5e1-8_5000_1_20_10_SINRCdf.pdf}
