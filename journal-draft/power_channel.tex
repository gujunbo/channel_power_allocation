...
The greedy scheme consumes as less power as our proposed schemes when single channel is used, because many WBSs are in idle state. 
 ...
 \begin{figure}[h!]
    \centering
      \includegraphics[width=0.9\linewidth]{ECC_multiChannel_withComparison_Tx_1000.pdf}
...
With the increase of the amount of channels in use, the capacity of the two schemes increases linearly.
     \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{ECC_multiChannel_withComparison_Capacity_1000.pdf}
...
There are 5 TVWS channels.
 ...
 \begin{figure}[h!]
    \centering
      \includegraphics[width=0.9\linewidth]{ECC_multiChannel_withComparison_Tx_1000_16WBS.pdf}
...
\label{transPower2}    
  \end{figure}
       ...
       \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{ECC_multiChannel_withComparison_Capacity_1000_16WBS.pdf}
