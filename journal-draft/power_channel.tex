...
Yang et al.~\cite{yang2013WiFiWSTVCapacity} and Gopal et al.~\cite{gopalICC16} propose throughput maximization of a CSMA/CA based WiFi like network in TVWS under aggregate interference.
Potential game is also adopted by Elias et al.~\cite{Elias17} to mitigates the adjacent interference.
...
The centralized optimization scheme achieves the highest quasiSINR, because the optimization formulation~\ref{QLP} obtains the global optima.
 \begin{figure}[h!]
    \centering
      \includegraphics[width=0.9\linewidth]{aveageTxPOverChannels.pdf}
...
It is also noticed that, the maximum permitted transmission power decided by linear optimization helps the channel allocation schemes achieve better SINR.
     \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{SINR_overChannels.pdf}
  ...
  \begin{figure}[h!]
     \centering
     \includegraphics[width=0.8\linewidth]{SINRCdf.pdf}
