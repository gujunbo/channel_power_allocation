...
In this paper, we focus on the co-existence issue of the WBSs and look into the multiple channel allocation problem in TV white space with respect to ECC and FCC regulations respectively.
The main contributions of this work can be summarized as follows:
\begin{itemize} 
\item We devise both centralized and distributed schemes to make use of TVWS and improve the Shannon capacity on end users with respect to ECC rules. 
To our knowledge, this is the first effort made to utilize multiple channels with ECC restrictions. 
\item We formulate the channel allocation problem with different transmission power into congestion game, and derive the distributed algorithms which converge to Nash Equilibrium. 
...
The two schemes consume the same energy working with single channel, while the distributed scheme consumes two times more than the centralized optimization.
 ...
 \begin{figure}[h!]
    \centering
      \includegraphics[width=0.9\linewidth]{ECC_multiChannel_Tx.pdf}
    \caption{Average transmission power of WBSs}
\label{transPower}    
  \end{figure}
...
With the increase of the amount of channels in use, the capacity of the two schemes increases linearly.
     \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{ECC_multiChannel_Capacity.pdf}
       \caption{Average capacity on end terminals}
