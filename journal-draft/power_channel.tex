...
\maketitle
\graphicspath{
{../figures/03_distributedChannelAllocation/}{../figure/03_distributedChannelAllocation/1mar2016/}{../figure/03_distributedChannelAllocation/1mar2016/radius_6000_runtimes_50/}{../../channel-power-allocation-802.22/}
}
...
WhiteCat adopts the best response process, where each WBS (referred as $i$) chooses the channel which brings the larger utility $u_i$ as the response of other WBSs' choices on channels.
...
The centralized optimization scheme achieves the highest quasiSINR, because the optimization formulation~\ref{QLP} obtains the global optima.
 \begin{figure}[h!]
    \centering
      \includegraphics[width=0.9\linewidth]{ECC_10_3_e1-8_4000_1_20_10_2.pdf}
...
\label{transPower}    
  \end{figure}
   ...
   \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{ECC_10_3_e1-8_4000_1_20_10_1.pdf}
...
It is also noticed that, the maximum permitted transmission power decided by linear optimization helps the channel allocation schemes achieve better SINR.
     \begin{figure}[h!]
       \centering
       \includegraphics[width=0.9\linewidth]{ECC_10_3_e1-8_4000_1_20_10_0.pdf}
  ...
  \begin{figure}[h!]
     \centering
     \includegraphics[width=0.8\linewidth]{ECC_10_3_e1-8_4000_1_20_10_3.pdf}
...
Figure~\ref{sumOfUtility} shows the utilities obtained by optimization is larger than distributed scheme.
Note the distributed scheme takes an advantage that some WBSs are allowed to be idle, in comparison, any WBS in optimization must operate with a power level.
\begin{figure}[h!]
  \centering
      \includegraphics[width=0.8\linewidth]{FCC_10_3_e1-8_4000_1_20_10_2.pdf}
  		\caption{Sum of Utility}
     \label{sumOfUtility}
\end{figure}

Figure~\ref{FCCQuasiSINR} and~\ref{FCCSINREndUsers} shows the distributed scheme outperforms the centralized scheme in terms of both quasiSINR and SINR on end users.
Figure~\ref{FCCSINRCdf} provides another perspective for the SINR on the end users.
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\linewidth]{FCC_10_3_e1-8_4000_1_20_10_0.pdf}
  \caption{QuasiSINR}
\label{FCCQuasiSINR}
\end{figure}
...
\begin{figure}[h!]
  \centering
      \includegraphics[width=0.8\linewidth]{FCC_10_3_e1-8_4000_1_20_10_4.pdf}
...
\begin{figure}[h!]
  \centering
      \includegraphics[width=0.8\linewidth]{FCC_10_3_e1-8_4000_1_20_10_3.pdf}
  		\caption{Cumulative distribution of SINR on end users after channel and power allocation}
     \label{FCCSINRCdf}
\end{figure}

The distributed scheme also saves power as shown in Figure~\ref{FCCTxpower}, because some of the WBSs are allowed to be idle.
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\linewidth]{FCC_10_3_e1-8_4000_1_20_10_1.pdf}
